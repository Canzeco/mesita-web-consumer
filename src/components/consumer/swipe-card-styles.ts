...
export const SWIPE_CARD_CLIP =
  "overflow-hidden rounded-3xl" as const;
...
export const SWIPE_CARD_PHOTO_SIZES = "(max-width: 768px) 100vw, 420px" as const;
...
export const SWIPE_CARD_COVER_PHOTO =
...
/** WITC — solid blue fields strip below the photo band. */
export const SWIPE_CARD_FIELDS_STRIP = "bg-swipe-panel shrink-0" as const;
