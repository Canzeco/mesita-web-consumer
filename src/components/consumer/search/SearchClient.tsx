...
export function SearchClient({
  ...
  // the "3 / 12" pager so the horizontal rail reads as browsable, not stuck.
            ...
            <>
              {visible.length > 1 && (
                <div className="mb-2 flex justify-center">
                  <span className="border-border bg-card/95 text-muted-foreground shadow-sm flex items-center gap-1 rounded-full border px-2.5 py-1 text-[11px] font-semibold tabular-nums backdrop-blur">
