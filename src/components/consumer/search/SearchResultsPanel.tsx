...
export function SearchResultsPanel({
  ...
  return (
    <div className="border-border bg-background/95 shadow-elev absolute inset-x-3 top-[68px] z-40 flex max-h-[72%] flex-col overflow-hidden rounded-2xl border backdrop-blur-xl">
