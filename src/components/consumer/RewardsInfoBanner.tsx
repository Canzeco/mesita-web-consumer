    ...
    <div className="border-border/70 from-primary/5 via-secondary/5 to-accent/5 rounded-2xl border bg-gradient-to-br p-3">
      ...
      <div className="mt-2 space-y-1.5">
        <div className="flex items-start gap-2.5">
          <span className="bg-secondary/12 text-secondary flex h-6 w-6 shrink-0 items-center justify-center rounded-lg">
        ...
        <div className="flex items-start gap-2.5">
          <span className="bg-tier-premium flex h-6 w-6 shrink-0 items-center justify-center rounded-lg text-white">
            <Crown className="h-3.5 w-3.5 fill-current" />
          </span>
          <p className="text-foreground text-[12px] leading-snug">
            <span className="font-semibold">Premium boosts them.</span>{" "}
            <span className="text-muted-foreground">
              Free gets the base discount; Premium unlocks bigger ones.
            </span>
          </p>
        </div>
      </div>
