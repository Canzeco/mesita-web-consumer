...
// The Share page (canonical /share; /invite redirects here) is just five gift
// cards — one per audience — each a credit-card-proportioned gradient tile
// (ISO/IEC 7810 ID-1, 85.6×53.98) with its own Share button on top. No codes,
// no rewards, no tabs. The page carries no chrome header — it's reached from
// the Me page's Share box.
//
