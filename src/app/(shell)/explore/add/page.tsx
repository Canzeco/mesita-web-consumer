...
export default function ExploreAddPage() {
        ...
        <section className="border-border bg-card w-full rounded-2xl border p-3 text-left">
          ...
          {!hasStartedSearch && (
            <p className="text-muted-foreground mt-3 px-1 text-center text-[12px] leading-relaxed">
              ...
              AI by searching the internet, and it will be created as not
              verified until someone verifies ownership.
            </p>
          )}
          ...
          {isAdding ? (
            ...
            <p className="text-muted-foreground mt-2 text-center text-[11px]">
              AI generates this profile by searching the internet. It is listed
              as not verified until someone verifies ownership.
            </p>
          )}
