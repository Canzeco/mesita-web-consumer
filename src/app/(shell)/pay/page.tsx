...
// Rewards is one page: banner + Mesita passport (QR/code) + tickets. Legacy
// /pay/qr and /pay/tickets redirect here (see [tab]/page.tsx).
export default async function RewardsPage() {
  ...
  if (!user) {
    redirect(`/?next=${encodeURIComponent(CONSUMER_ROUTE_PREFIX.pay)}`);
  }
